...
df1_train_result = pd.DataFrame(
    {"Student": [101, 102, 103, 104], "Grades": [100, 80, 75, 95]}
)
...
df2_train_result = df1_train_result = pd.DataFrame(
    {"Student": [101, 102, 103, 104], "Grades": [100, 80, 75, 95]}
)
...
df3_train_result = df1_train_result = pd.DataFrame(
    {"Student": [101, 102, 103], "Grades": [100, 80, 75]}
)
